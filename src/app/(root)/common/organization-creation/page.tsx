...
// import Scene from "@/components/Minimap";
...
//     let addressFieldKey: keyof typeof addressFieldMap;
//     for (addressFieldKey in addressFieldMap) {
//       const value = addressFieldMap[addressFieldKey];
//       setValue(`addressForm.${addressFieldKey}`, value);
//     }
