...
export default function NewVendorCreditDialog({ organizationId }: Props) {
  ...
  const usePostVendorCreditPaymentMutationResult =
  ...
  useEffect(() => {
    if (
      ...
      usePostVendorCreditPaymentMutationResult.isSuccess
    ) {
      form.reset();
    }
  }, [
  ...
  async function onSubmit(values: FieldValues) {
    await usePostVendorCreditPaymentMutationResult
      .mutateAsync({
